...
/**
 * Convertit un CompleteResumeResponse en PlayerSubmissionInput pour la soumission
 */
export function convertResumeToSubmission(
  ...
  return {
    ...
    career_seasons: data.career_seasons.map((season) => ({
      ...
      clubs: season.clubs
        ...
        .map((club) => ({
          division_name: club.division_name,
