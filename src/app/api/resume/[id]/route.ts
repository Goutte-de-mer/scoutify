...
export async function PUT(
  ...
  try {
    ...
    if (
      ...
      !body.player_profile &&
      !body.contacts &&
      body.qualities === undefined &&
      body.career_seasons === undefined &&
      body.training_entries === undefined &&
      body.club_interests === undefined
    ) {
      return NextResponse.json(
    ...
    if (body.player_profile) {
      ...
      if (
        body.player_profile.birth_date !== undefined &&
        !/^\d{4}-\d{2}-\d{2}$/.test(body.player_profile.birth_date)
      ) {
        return NextResponse.json(
          {
    ...
    if (body.contacts) {
      ...
      if (
        body.contacts.player_email !== undefined &&
        !emailRegex.test(body.contacts.player_email)
      ) {
        return NextResponse.json(
      ...
      if (
        body.contacts.agent_email !== undefined &&
        body.contacts.agent_email !== null &&
